...
import {
    ...
    useMixedPipeline,
    mixedPipelineCode,
    useLargeV1TransactionPipeline,
    largeV1TransactionCode,
    jupiterSwapCode,
...
const pipelineExamples: PipelineExampleConfig[] = [
    ...
    },
    {
        ...
        hook: useLargeV1TransactionPipeline,
        code: largeV1TransactionCode,
    },
    {
        id: 'jupiter-swap',
        name: 'Jupiter Swap',
        description: 'Swap tokens through Jupiter Metis with @pipeit/actions/metis',
    ...
    },
    {
        id: 'titan-swap',
        name: 'Titan Swap',
        description: 'Swap tokens through Titan with the @pipeit/actions/titan InstructionPlan API',
